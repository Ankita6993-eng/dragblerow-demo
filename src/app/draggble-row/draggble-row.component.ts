...
@Component({
  selector: 'app-draggble-row',
  templateUrl: './draggble-row.component.html',
  styleUrls: ['./draggble-row.component.css']
})
export class DraggbleRowComponent implements OnInit {
